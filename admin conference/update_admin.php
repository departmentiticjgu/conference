...
<body>
    ...
    <div class="page-content">
            <?php
                ...
                foreach ($conference->GetIdAdmin($_GET['id']) as $row) {
            ?>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="action.php?action=update_admin" method="post" class="form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-4">
                                <label for="username" class="form-label">
                                    <i class="bi bi-person-fill me-2"></i>Username Admin
                                </label>
                            ...
                            <div class="form-group mb-4">
                                <label for="full_name" class="form-label">
                                    <i class="bi bi-person-fill me-2"></i>Full Name Admin
                                </label>
                                <div class="input-group">
                            ...
                            <div class="form-group mb-4">
                                <label for="no_hp" class="form-label">
                                    <i class="bi bi-telephone-fill me-2"></i>No Handphone Admin
                                </label>
                                <div class="input-group">
                                    <input type="text" name="no_hp" id="no_hp" class="form-control" value="<?= $row['no_hp'] ?>">
                                </div>
                            </div>
                        </div>
