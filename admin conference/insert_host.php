    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Insert Co-Host</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=insert_host" method="post" class="form" enctype="multipart/form-data">
                    <div class="row">
                        <!-- Kolom Kiri -->
                        <div class="col-md-6">
                            <!-- Nama Conference -->
                            <div class="form-group mb-4">
                                <label for="image" class="form-label">
                                    <i class="bi bi-person-fill me-2"></i>Image
                                </label>
