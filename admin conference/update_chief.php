...
<body>
    ...
    <div class="page-content">
            <?php
                ...
                foreach ($conference->GetIdChief($_GET['id']) as $row) {
            ?>
        <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Update Chief Editors</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=update_chief" method="post" class="form">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-4">
                                <label for="university" class="form-label">
                                    <i class="bi bi-map-fill me-2"></i>University
                                </label>
                                <input type="text" name="university" id="university" class="form-control" value="<?= $row['university'] ?>">
                            </div>
