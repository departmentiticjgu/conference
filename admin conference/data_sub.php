            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Sub-Topic</h4>
                    </div>
                    <div class="card-body">
                        <!-- Tabel Topic -->
                         <a href="data_topic.php" class="btn btn-secondary">Back To Topic</a>
                         <a href="insert_sub.php" class="btn btn-primary">Insert Sub-Topic</a>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="small"><?= $row['subtopic']?></td>
                                        <td class="small">
                                            <a href="update_sub.php?id=<?= $row['id_subtopic'] ?>" class="btn btn-success">Update</a>
                                            <a href="action.php?action=delete_sub&id=<?= $row['id_subtopic'] ?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
