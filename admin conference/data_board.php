            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Editorial Board</h4>
                    </div>
                    <div class="card-body">
                        <!-- Tabel User -->
                         <a href="insert_board.php" class="btn btn-primary">Insert Editorial Board</a>
                        <div class="table-responsive">
                            <table class="table table-striped" id="table1">
                                ...
                                <?php
                                    ...
                                    foreach ($conference->TampilBoard() as $row) {
                                ?>
                                    <tr>
                                        <td class="small"><?= $no++?></td>
                                        <td class="small"><?= $row['name']?></td>
                                        <td class="small">
                                            <a href="update_board.php?id=<?= $row['id']?>" class="btn btn-success">Update</a>
                                            <a href="action.php?action=delete_board&id=<?= $row['id']?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
