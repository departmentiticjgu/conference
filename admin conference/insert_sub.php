    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Insert Sub-Topic</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=insert_sub" method="post" class="form">
                    <div class="row">
                        <!-- Kolom Kiri -->
                        <div class="col-md-6">
                            <!-- Nama Lengkap -->
                            <?php
                                ...
                                ?>
                                <label class="form-label"><i class="bi bi-building me-2"></i>Topic Name </label>
                                <select name="topic_id" class="form-select mb-3" required>
                                    <option value="" disabled selected>Select a Topic Name</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- <div class="form-group mb-4">
                                ...
                                <input type="number" name="no_hp" id="telepon" class="form-control">
                            </div> -->
