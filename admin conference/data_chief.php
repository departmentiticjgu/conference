            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Chief Editors</h4>
                    </div>
                    <div class="card-body">
                        <!-- Tabel Conference -->
                         <a href="insert_chief.php" class="btn btn-primary">Insert Chief Editors</a>
                        <div class="table-responsive">
                            <table class="table table-striped" id="table1">
                                ...
                                <?php
                                    ...
                                    foreach ($conference->TampilChief() as $row) {
                                ?>
                                    <tr>
                                        <td class="small"><?= $no++?></td>
                                        <td class="small"><?= $row['name']?></td>
                                        <td class="small"><?= $row['title']?></td>
                                        <td class="small"><?= $row['university']?></td>
                                        <td class="small">
                                            <a href="update_chief.php?id=<?= $row['id']?>" class="btn btn-success">Update</a>
                                            <a href="action.php?action=delete_chief&id=<?= $row['id']?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
