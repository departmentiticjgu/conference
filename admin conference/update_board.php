    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Editorial Board Data</h3>
            </div>

    <div class="page-content">
            <?php
                require_once "koneksi.php";
                foreach ($conference->GetIdBoard($_GET['id']) as $row) {
            ?>
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Update Editorial Board</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=update_board" method="post" class="form">
                    <div class="row">
                    <input type="hidden" name="id" class="form-control mb-3" id="id" value="<?= $row['id'] ?>">
                        <!-- Kolom Kiri -->
                        <div class="col-md-6">
                            <!-- Nama Conference -->
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="form-label">
                                    <i class="bi bi-lock-fill me-2"></i>Name Editorial Board
                                </label>
                        ...
                        <div class="col-md-6">
                            <!-- <?php
                                ...
                                <label class="form-label">Nama Conference</label>
                                    <select name="id_conference" class="form-select mb-3" required>
                                        <option value="" disabled>Pilih Conference</option>
                                        <?php 
                                        $result = $conference->TampilBoard();
                                        while ($conf = $result->fetch_assoc()) { 
                                            $selected = ($conf['id_conference'] == $row['id_conference']) ? 'selected' : '';
                                        ?>
                                        <option value="<?= $conf['id_conference'] ?>" <?= $selected ?>><?= $conf['nama_conference'] ?></option>
                                        <?php } ?>
                                    </select> -->
                            ...
                            <!-- <div class="form-group mb-4">
                                <label for="tanggal_daftar" class="form-label">
                                    <i class="bi bi-map-fill me-2"></i>Tanggal Daftar
                                </label>
                                <input type="date" name="tanggal_daftar" id="tanggal_daftar" class="form-control" value="<?= $row['tanggal_daftar'] ?>">
                            </div> -->
