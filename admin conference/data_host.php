            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Co-Host</h4>
                    </div>
                    <div class="card-body">
                        <!-- Tabel Conference -->
                         <a href="insert_host.php" class="btn btn-primary">Insert Co-Host</a>
                        <div class="table-responsive">
                            <table class="table table-striped" id="table1">
                                ...
                                <?php
                                    ...
                                    foreach ($conference->TampilHost() as $row) {
                                ?>
                                    <tr>
                                        <td class="small"><?= $no++?></td>
                                        <td><img src="image/<?= $row['image']?>" width="400px" height="70px"></td>
                                        <td class="small"><?= $row['name']?></td>
                                        <td class="small">
                                            <a href="update_host.php?id=<?= $row['id']?>" class="btn btn-success">Update</a>
                                            <a href="action.php?action=delete_host&id=<?= $row['id']?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                   <?php } ?>
                                </tbody>
