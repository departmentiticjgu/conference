...
<body>
    ...
    <?php
                ...
                foreach ($conference->GetIdAssociate($_GET['id']) as $row_session) {
            ?>
        <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Update Associate Editors</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=update_associate" method="post" class="form">
                <input type="hidden" name="id" class="form-control mb-3" id="id" value="<?= $row_session['id'] ?>">
                    <div class="row">
                        <!-- Kolom Kiri -->
                        <div class="col-md-6">
                            <!-- Nama Conference -->
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="form-label">
                                    <i class="bi bi-map-fill me-2"></i>Name Associate Editors
                                </label>
                                <input type="text" name="name" id="name" class="form-control" value="<?= $row_session['name'] ?>">
                            </div>
                                
                            <!-- Password -->
                            <!-- <div class="form-group mb-4">
                                <label for="lokasi" class="form-label">
                                    <i class="bi bi-lock-fill me-2"></i>Lokasi Conference
                                </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- <div class="form-group mb-4">
                                <label for="waktu_mulai" class="form-label">
                                    <i class="bi bi-map-fill me-2"></i>Waktu Mulai
                                </label>
                                <input type="time" name="waktu_mulai" id="waktu_mulai" class="form-control" value="<?= $row_session['waktu_mulai'] ?>">
                            </div> -->

                            <!-- Nomor Telepon -->
                            <!-- <div class="form-group mb-4">
                                <label for="waktu_selesai" class="form-label">
                                    <i class="bi bi-file-fill me-2"></i>Waktu Selesai
                                </label>
                                <input type="time" name="waktu_selesai" id="waktu_selesai" class="form-control" value="<?= $row_session['waktu_selesai'] ?>"> 
                            </div> -->
