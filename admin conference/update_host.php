...
<body>
    ...
    <div class="page-content">
            <?php
                ...
                foreach ($conference->GetIdHost($_GET['id']) as $row) {
            ?>
            <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Update Conference</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=update_host" method="post" class="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="form-group mb-4">
                            ...
                            <!-- Image Lama -->
                             <label for="form-label">Image Lama:</label>
                            <img src="image/<?= $row['image'] ?>" alt="Image Lama" width="100px" height="100px" class="mb-2">


                            <!-- Tanggal Conference -->
                            <!-- <div class="form-group mb-4">
                                <label for="tanggal" class="form-label">
                                    <i class="bi bi-calendar-fill me-2"></i>Tanggal Conference
                                </label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="form-label">
                                    <i class="bi bi-map-fill me-2"></i>Name Co-Host
                                </label>
                            ...
                            <!-- <div class="form-group mb-4">
                                ...
                                <textarea name="deskripsi" id="deskripsi" class="form-control" cols="10" rows="5"><?= $row['deskripsi'] ?></textarea>
                            </div> -->
