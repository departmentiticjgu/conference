    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Sub-Topic Data</h3>
            </div>

            <?php
                require_once "koneksi.php";
                foreach ($conference->GetIdSub($_GET['id']) as $row) {
            ?>
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Update Sub-Topic</h4>
            </div>
            <div class="card-body">
                <form action="action.php?action=update_sub" method="post" class="form">
                            ...
                            <?php
                                ...
                                <label class="form-label">Topic Name</label>
                                    <select name="topic_id" class="form-select mb-3" required>
                                        <option value="" disabled>Select a Topic Name</option>
                                        <?php 
                                        $result = $conference->TampilTopic();
                                        while ($conf = $result->fetch_assoc()) { 
                                            $selected = ($conf['id'] == $row['topic_id']) ? 'selected' : '';
                                        ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-4">
                                <label for="name" class="form-label">
                                    <i class="bi bi-building me-2"></i>Sub-Topic
                                </label>
                            ...
                            <!-- <div class="form-group mb-4">
                                ...
                                <input type="number" name="no_hp" id="telepon" class="form-control" value="<?= $row['no_hp'] ?>" required>
                            </div> -->
                           ...
                           <!-- Role -->
                            <!-- <div class="form-group mb-4">
                                ...
                                <option value="pembicara" <?= ($row['role'] == 'pembicara') ? 'selected' : '' ?>>Pembicara</option>
